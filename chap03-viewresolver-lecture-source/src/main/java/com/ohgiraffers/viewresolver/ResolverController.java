...
public class ResolverController {
    ...
    public String stringReturning(Model model) {
        ...
        resources/templates/ 를 prefix 로 지정하고
        .html 을 suffix 로 하여
    ...
    public String stringRedirect() {
        ...
        // redirect: 접두사를 붙이면 forward 가 아닌 redirect 를 한다.
    ...
    public ModelAndView modelAndViewReturning(ModelAndView mv){
        ...
        ModelAndView
        모델과 뷰를 합친 개념
        핸들러 어뎁터가 핸들러 메소드를 호출하고 반환받은 문자열을 (ModelAndView) 로 만들어
